...
The following code chunk contains the code needed to make a visualization of my personal data along with the calculations that I made earlier (standard deviation, standard error, upper and lower quartiles). I started by choosing the data object 'average_money_summary' to 
